...
cat license.lic
./apigw-emt-scripts-2.4.0/build_gw_image.py --license=license.lic --domain-cert=apimgr/certs/$1/cert.pem --domain-key=apimgr/certs/$1/key.pem --domain-key-pass-file=apimgr/certs/$1/pass.txt --merge-dir apimgr/merge-dir/apigateway --pol=apimgr/policy/$1/bct.pol --env=apimgr/environment/$1/bct.env --fed-pass-file=apimgr/nopass.txt --parent-image=romaicus/apim_base:77-20220416 --out-image=romaicus/apimgr:77-20220416
